...
// Success/safe: permission LOW level, confirmations, healthy status.
...
// Danger/critical: permission DANGER level, destructive actions, security alerts.
// Distinct from M3 error — error is for validation, danger is for security severity.
val dangerLight = Color(0xFFC62828)
val onDangerLight = Color(0xFFFFFFFF)
val dangerContainerLight = Color(0xFFFFCDD2)
val onDangerContainerLight = Color(0xFF8E0000)
...
val onSuccessDark = Color(0xFF1B3A1C)
val successContainerDark = Color(0xFF1B3A1C)
val onSuccessContainerDark = Color(0xFFC8E6C9)

val dangerDark = Color(0xFFEF5350)
val onDangerDark = Color(0xFF3B0000)
val dangerContainerDark = Color(0xFF4E0000)
val onDangerContainerDark = Color(0xFFFFCDD2)