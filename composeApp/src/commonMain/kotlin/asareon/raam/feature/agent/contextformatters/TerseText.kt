...
object TerseText {
    ...
    private val verboseTexts = mapOf(
        ...
        "ACTIONS_PREAMBLE" to buildString {
            ...
            appendLine("- Identity references (e.g. session, sender, agent fields) accept any of: full handle (`session.testing-session`), UUID, or display name.")
    ...
    private val terseTexts = mapOf(
        ...
        "ACTIONS_PREAMBLE" to buildString {
            ...
            appendLine("Identity refs (sessions, agents, users) accept handle, UUID, or display name.")
