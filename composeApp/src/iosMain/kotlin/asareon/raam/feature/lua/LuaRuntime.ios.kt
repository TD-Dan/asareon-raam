...
/**
 * Stub implementation for iOS. Lua scripting is not available on this platform.
 */
actual class LuaRuntime actual constructor(config: LuaRuntimeConfig) {
    ...
    actual fun loadScript(scriptHandle: String, scriptName: String, sourceCode: String): LuaExecutionResult {
        return LuaExecutionResult(success = false, error = "Lua scripting is not available on this platform (iOS)")
    }
